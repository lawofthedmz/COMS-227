...
public class PlatformWithFollowerTest {
	...
	public static void main(String[] args) {
		...
		b.addAssociated(e);
		System.out.println(e.getMin() + " expected 50"); // 50
		System.out.println(e.getMax() + " expected 60"); // 60

		// x position should be the base position + 2 = 52
		// y position should be base y - follower height = 195
		System.out.println(e.getXReal() + " expected 52"); // expected 52
		System.out.println(e.getYReal()  + " expected 195"); // expected 195
		...
		System.out.println("bounds " + e.getMin() + ", " + e.getMax()); // 53, 63
		System.out.println(e.getXReal() + ", " + (e.getXReal() + 5) + " expected 57, 62"); // 57, 62
